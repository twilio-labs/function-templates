...
exports.handler = async function (context, event, callback) {
  ...
  const APPLICATION_CUSTOMER_NAME      = await retrieveParameter(context, 'APPLICATION_CUSTOMER_NAME');
  ...
  console.log(THIS, 'Replacing YOUR_HEALTH_SYSTEM_NAME      ->', APPLICATION_CUSTOMER_NAME);
  console.log(THIS, 'Replacing YOUR_SERVICE_SID             ->', TWILIO_SERVICE_SID);
  console.log(THIS, 'Replacing YOUR_ENVIRONMENT_SID         ->', TWILIO_ENVIRONMENT_SID);
  console.log(THIS, 'Replacing YOUR_ENVIRONMENT_DOMAIN_NAME ->', TWILIO_ENVIRONMENT_DOMAIN_NAME);
  ...
  let flow_definition =  fs.readFileSync(flow_definition_file).toString('utf-8')
    .replace('YOUR_HEALTH_SYSTEM_NAME', APPLICATION_CUSTOMER_NAME)
    .replaceAll('YOUR_SERVICE_SID', TWILIO_SERVICE_SID)
    .replaceAll('YOUR_ENVIRONMENT_SID', TWILIO_ENVIRONMENT_SID)
    .replaceAll('YOUR_ENVIRONMENT_DOMAIN_NAME', TWILIO_ENVIRONMENT_DOMAIN_NAME);
  ...
  switch (action) {
    ...
    case 'UPDATE':
    {
      console.log(THIS, 'Updating flow FLOW_SID=', TWILIO_FLOW_SID);
    ...
    case 'DELETE':
    {
      console.log(THIS, 'Deleting FLOW_SID=', TWILIO_FLOW_SID);
