...
| MESSAGE_QUANTITY            | The number of messages a user will receive per transaction.                                                                                                                                 | Recommended |
| MESSAGE_INTERVAL            | The interval at which a user will receive SMS, e.g. per month or per delivery.                                                                                                              | Recommended |
