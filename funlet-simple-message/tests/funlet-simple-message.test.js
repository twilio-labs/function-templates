const funlet = require('../functions/funlet-simple-message.protected');
...
test('[SIMPLE-MESSAGE-INPUT-MESSAGES-1] Read Single Message from Event', () => {
  expect(funlet.input.getMessages({ Message: MESSAGE1 }, {}, {})).toEqual([
    MESSAGE1,
  ]);
});
...
test(
  '[SIMPLE-MESSAGE-INPUT-MESSAGES-3] ' +
...
test(
  '[SIMPLE-MESSAGE-INPUT-MESSAGE-7] ' +
...
test(
  '[SIMPLE-MESSAGE-INPUT-LANGUAGE-4] ' +
...
test(
  '[SIMPLE-MESSAGE-OUTPUT-SIMPLE-MESSAGE-0] ' +
