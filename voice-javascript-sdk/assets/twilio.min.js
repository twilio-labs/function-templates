  ...
  })()(
    {
          ...
          let AudioHelper = (function (_super) {
            ...
            function AudioHelper(onActiveOutputsChanged, onActiveInputChanged, getUserMedia, options) {
              ...
              _this._removeLostInput = function (lostDevice) {
                ...
                const defaultDevice =
                  _this.availableInputDevices.get('default') || Array.from(_this.availableInputDevices.values())[0];
                if (defaultDevice) {
              ...
              _this._removeLostOutput = function (lostDevice) {
                ...
                const wasRingtoneLost = _this.ringtoneDevices.delete(lostDevice);
              ...
              const isEnumerationSupported = Boolean(_this._mediaDevices && _this._mediaDevices.enumerateDevices);
            ...
            AudioHelper.prototype._initializeEnumeration = function () {
              ...
              this._updateAvailableDevices().then(function () {
                ...
                Promise.all([_this.speakerDevices.set('default'), _this.ringtoneDevices.set('default')]).catch(
                  function (reason) {
            ...
            AudioHelper.prototype._updateDevices = function (updatedDevices, availableDevices, removeLostDevice) {
              ...
              const knownDeviceIds = Array.from(availableDevices.values()).map(function (d) {
                return d.deviceId;
              });
              const lostActiveDevices = [];
              const lostDeviceIds = util_1.difference(knownDeviceIds, updatedDeviceIds);
              ...
              updatedDevices.forEach(function (newDevice) {
                ...
                const newMediaDeviceInfo = _this._wrapMediaDeviceInfo(newDevice);
          ...
          let Call = (function (_super) {
            ...
            function Call(config, options) {
              ...
              _this._onHangup = function (payload) {
                ...
                if (payload.error) {
                  const error = new errors_1.GeneralErrors.ConnectionError('Error sent from gateway in HANGUP');
              ...
              _this._onMediaFailure = function (type) {
                ...
                if (
                  ...
                  const mediaReconnectionError = new errors_1.MediaErrors.ConnectionError('Media connection failed.');
              ...
              const monitor = (_this._monitor = new (_this._options.StatsMonitor || statsMonitor_1.default)());
              ...
              _this._mediaHandler.onicecandidate = function (candidate) {
                const payload = new icecandidate_1.IceCandidate(candidate).toPayload();
              ...
              _this._mediaHandler.onselectedcandidatepairchange = function (pair) {
                const localCandidatePayload = new icecandidate_1.IceCandidate(pair.local).toPayload();
                const remoteCandidatePayload = new icecandidate_1.IceCandidate(pair.remote, true).toPayload();
              ...
              _this._mediaHandler.onerror = function (e) {
                ...
                const error = e.info.twilioError || new errors_1.GeneralErrors.UnknownError(e.info.message);
              ...
              _this.on('error', function (error) {
                _this._publisher.error('connection', 'error', { code: error.code, message: error.message }, _this);
            ...
            Call.prototype.accept = function (options) {
              ...
              const connect = function () {
                ...
                const onAnswer = function (pc) {
                  const eventName =
                    _this._direction === Call.CallDirection.Incoming ? 'accepted-by-local' : 'accepted-by-remote';
                  _this._publisher.info('connection', eventName, null, _this);
                  const _a = getPreferredCodecInfo(_this._mediaHandler.version.getSDP());
                  const { codecName } = _a;
                ...
                const sinkIds = typeof _this._options.getSinkIds === 'function' && _this._options.getSinkIds();
              ...
              promise.then(
                function () {
                  _this._publisher.info('get-user-media', 'succeeded', { data: { audioConstraints } }, _this);
                  connect();
                },
                function (error) {
                  let twilioError;
            ...
            Call.prototype.postFeedback = function (score, issue) {
              ...
              if (!Object.values(Call.FeedbackScore).includes(score)) {
                throw new errors_1.InvalidArgumentError(
                  `Feedback score must be one of: ${Object.values(Call.FeedbackScore)}`,
                );
              }
              if (
                ...
                throw new errors_1.InvalidArgumentError(
                  `Feedback issue must be one of: ${Object.values(Call.FeedbackIssue)}`,
                );
              }
          ...
          let Device = (function (_super) {
            ...
            function Device(token, options) {
              ...
              _this._onSignalingError = function (payload) {
                ...
                const call = (typeof callsid === 'string' && _this._findCall(callsid)) || undefined;
                      ...
                      case 0:
                        ...
                        if (!payload.callsid || !payload.sdp) {
                          this.emit(
                            ...
                            new errors_1.ClientErrors.BadRequest('Malformed invite from gateway'),
                          );
                          return [2];
                        }
              ...
              _this._updateInputStream = function (inputStream) {
                ...
                if (call && !inputStream) {
                  return Promise.reject(
                    new errors_1.InvalidStateError('Cannot unset input device while a call is in progress.'),
                  );
                }
              ...
              _this._updateSinkIds = function (type, sinkIds) {
                const promise =
                  type === 'ringtone' ? _this._updateRingtoneSinkIds(sinkIds) : _this._updateSpeakerSinkIds(sinkIds);
                return promise.then(
                  function () {
                    _this._publisher.info(
                      'audio',
              ...
              if (window) {
                ...
                _this._isBrowserExtension =
                  (Boolean(browser) && Boolean(browser.runtime) && Boolean(browser.runtime.id)) ||
            ...
            Object.defineProperty(Device, 'extension', {
              get() {
                ...
                let canPlayMp3;
                try {
                  canPlayMp3 = a.canPlayType && Boolean(a.canPlayType('audio/mpeg').replace(/no/, ''));
                } catch (e) {
                  canPlayMp3 = false;
                }
                let canPlayVorbis;
                try {
                  canPlayVorbis =
                    a.canPlayType && Boolean(a.canPlayType("audio/ogg;codecs='vorbis'").replace(/no/, ''));
                } catch (e) {
                  canPlayVorbis = false;
                }
            ...
            Device.prototype.updateOptions = function (options) {
              ...
              const newChunderURIs = (this._chunderURIs = (
                chunderw || regions_1.getChunderURIs(this._options.edge, undefined, this._log.warn.bind(this._log))
              ).map(function (uri) {
                return `wss://${uri}/signal`;
              }));
              let hasChunderURIsChanged = originalChunderURIs.size !== newChunderURIs.length;
              if (!hasChunderURIsChanged) {
                for (let _i = 0, newChunderURIs_1 = newChunderURIs; _i < newChunderURIs_1.length; _i++) {
              ...
              this._log.setDefaultLevel(
                typeof this._options.logLevel === 'number' ? this._options.logLevel : loglevel_1.levels.ERROR,
              );
              ...
              for (let _a = 0, _b = Object.keys(Device._defaultSounds); _a < _b.length; _a++) {
                const name_1 = _b[_a];
                ...
                const soundUrl = (this._options.sounds && this._options.sounds[name_1]) || defaultUrl;
                const sound = new (this._options.Sound || Sound)(name_1, soundUrl, {
        ...
        function (require, module, exports) {
          ...
          const DialtonePlayer = (function () {
            ...
            DialtonePlayer.prototype.play = function (sound) {
              ...
              const oscillators = [this._context.createOscillator(), this._context.createOscillator()];
          ...
          (function (AuthorizationErrors) {
            const AccessTokenInvalid = (function (_super) {
              ...
              function AccessTokenInvalid(messageOrError, error) {
                ...
                const message = typeof messageOrError === 'string' ? messageOrError : _this.explanation;
                const originalError = typeof messageOrError === 'object' ? messageOrError : error;
      ...
      14: [
        function (require, module, exports) {
          ...
          EventPublisher.prototype._post = function _post(
            ...
            if (
              !connection ||
              ((!connection.parameters || !connection.parameters.CallSid) && !connection.outboundConnectionId)
            ) {
              return Promise.resolve();
            }
            const event = {
        ...
        function (require, module, exports) {
          ...
          const Log = (function () {
            function Log(options) {
              this._log = (options && options.LogLevelModule ? options.LogLevelModule : LogLevelModule).getLogger(
                constants_1.PACKAGE_NAME,
              );
            }
        ...
        function (require, module, exports) {
          ...
          const OutputDeviceCollection = (function () {
            ...
            OutputDeviceCollection.prototype.delete = function (device) {
              ...
              const defaultDevice =
                this._availableDevices.get('default') || Array.from(this._availableDevices.values())[0];
              if (!this._activeDevices.size && defaultDevice) {
                this._activeDevices.add(defaultDevice);
              }
              const deviceIds = Array.from(this._activeDevices.values()).map(function (deviceInfo) {
        ...
        function (require, module, exports) {
          ...
          let PreflightTest = (function (_super) {
            ...
            PreflightTest.prototype._getReport = function () {
              ...
              const { selectedIceCandidatePairStats } = this._rtcIceCandidateStatsReport;
              if (selectedIceCandidatePairStats) {
                report.selectedIceCandidatePairStats = selectedIceCandidatePairStats;
                report.isTurnRequired =
                  selectedIceCandidatePairStats.localCandidate.candidateType === 'relay' ||
            ...
            PreflightTest.prototype._getRTCStats = function () {
              const firstMosSampleIdx = this._samples.findIndex(function (sample) {
            ...
            PreflightTest.prototype._setupCallHandlers = function (call) {
                  ...
                  return __generator(this, function (_b) {
                    switch (_b.label) {
                      case 0:
                        ...
                        return [
                          4,
                          (this._options.getRTCIceCandidateStatsReport || stats_1.getRTCIceCandidateStatsReport)(
              ...
              [
                ...
                call._mediaHandler[handlerName] = function (state) {
                  const timing = (_this._networkTiming[reportLabel] = _this._networkTiming[reportLabel] || {
                    start: 0,
                  });
      ...
      18: [
        function (require, module, exports) {
          ...
          PStream.prototype._handleTransportMessage = function (msg) {
            ...
            const payload = _JSON$parse$payload === undefined ? {} : _JSON$parse$payload;
      ...
      19: [
        function (require, module, exports) {
          ...
          function getChunderURIs(edge, region, onDeprecated) {
            ...
            if (Boolean(edge) && typeof edge !== 'string' && !Array.isArray(edge)) {
              throw new errors_1.InvalidArgumentError(
            ...
            if (region && edge) {
              throw new errors_1.InvalidArgumentError(
                'You cannot specify `region` when `edge` is specified in' + '`Twilio.Device.Options`.',
              );
            } else if (region) {
              ...
              const isDeprecatedRegion = Object.values(DeprecatedRegion).includes(chunderRegion);
              if (isDeprecatedRegion) {
                chunderRegion = exports.deprecatedRegions[chunderRegion];
              }
              const isKnownRegion = Object.values(Region).includes(chunderRegion);
              if (isKnownRegion) {
                const preferredEdge = exports.regionToEdge[chunderRegion];
                deprecatedMessages.push(
                  `Region "${chunderRegion}" is deprecated, please use \`edge\` ` + `"${preferredEdge}".`,
                );
              }
      ...
      24: [
        function (require, module, exports) {
          ...
          const NativeRTCStatsReport = typeof window !== 'undefined' ? window.RTCStatsReport : undefined;
          ...
          MockRTCStatsReport.fromRTCStatsResponse = function fromRTCStatsResponse(statsResponse) {
            ...
            const statsMap = statsResponse.result().reduce(function (map, report) {
              const { id } = report;
              switch (report.type) {
        ...
        function (require, module, exports) {
          ...
          function PeerConnection(audioHelper, pstream, getUserMedia, options) {
            ...
            this._isSinkSupported =
              Boolean(AudioContext) && typeof HTMLAudioElement !== 'undefined' && HTMLAudioElement.prototype.setSinkId;
          ...
          PeerConnection.prototype._stopStream = function _stopStream(stream) {
            ...
            if (typeof MediaStreamTrack.prototype.stop === 'function') {
              const audioTracks =
                typeof stream.getAudioTracks === 'function' ? stream.getAudioTracks() : stream.audioTracks;
          ...
          PeerConnection.prototype._onInputDevicesChanged = function () {
            ...
            const activeInputWasLost = this.stream.getAudioTracks().every(function (track) {
          ...
          PeerConnection.prototype._onMediaConnectionStateChange = function (newState) {
            ...
            if (
              ...
              (newState !== 'connected' && newState !== 'disconnected' && newState !== 'failed')
            ) {
              return;
            }
          ...
          PeerConnection.prototype.iceRestart = function () {
            ...
            this._hasIceCandidates = false;
            this.version
              .createOffer(this.options.maxAverageBitrate, this.codecPreferences, { iceRestart: true })
              .then(function () {
                ...
                _this8._onAnswerOrRinging = function (payload) {
                  ...
                  if (!payload.sdp || _this8.version.pc.signalingState !== 'have-local-offer') {
                    const message =
                      ...
                      `hasSdp:${Boolean(payload.sdp)}, signalingState:${_this8.version.pc.signalingState}`;
                    _this8._log.info(message);
                    return;
                  }
                  const sdp = _this8._maybeSetIceAggressiveNomination(payload.sdp);
          ...
          function cloneStream(oldStream) {
            const newStream = typeof MediaStream !== 'undefined' ? new MediaStream() : new webkitMediaStream();
            ...
            (function () {
              ...
              RTCPC.prototype.processAnswer = function (codecPreferences, sdp, onSuccess, onError) {
                ...
                return promisifySet(
                  this.pc.setRemoteDescription,
                  this.pc,
                )(new RTCSessionDescription({ sdp, type: 'answer' })).then(onSuccess, onError);
              };
              RTCPC.test = function () {
                ...
                return function () {
                  ...
                  return new Promise(function (resolve) {
                    ...
                    return new Promise(function (resolve, reject) {
                      fn.apply(
                        ctx,
                        areCallbacksFirst ? [resolve, reject].concat(args) : args.concat([resolve, reject]),
                      );
                    });
                  });
                };
      ...
      28: [
        function (require, module, exports) {
              ...
              .concat(
                mediaSections.map(function (section) {
                  ...
                  const fixedBitratePayloadTypes =
                    kind === 'audio' ? new Set(pcmaPayloadTypes.concat(pcmuPayloadTypes)) : new Set();
          ...
          function getReorderedPayloadTypes(codecMap, preferredCodecs) {
            ...
            const preferredPayloadTypes = util.flatMap(preferredCodecs, function (codecName) {
              return codecMap.get(codecName) || [];
            });
            const remainingCodecs = util.difference(Array.from(codecMap.keys()), preferredCodecs);
            const remainingPayloadTypes = util.flatMap(remainingCodecs, function (codecName) {
              return codecMap.get(codecName);
            });
        ...
        function (require, module, exports) {
          ...
          function getRTCIceCandidateStatsReport(peerConnection) {
            return getRTCStatsReport(peerConnection).then(function (report) {
              const _a = Array.from(report.values()).reduce(function (rval, stat) {
              ...
              const { transport } = _a;
              const selectedCandidatePairReport = candidatePairs.find(function (pair) {
          ...
          EventTarget.prototype._defineEventHandler = function _defineEventHandler(eventName) {
            ...
            Object.defineProperty(this, `on${eventName}`, {
              ...
              set(newHandler) {
                ...
                if (
                  oldHandler &&
                  (typeof newHandler === 'function' || typeof newHandler === 'undefined' || newHandler === null)
                ) {
      ...
      32: [
        function (require, module, exports) {
          ...
          function MediaDevicesShim() {
            ...
            this._eventEmitter.on(
              ...
              function maybeStartPolling(eventName) {
                ...
                this._pollInterval =
                  this._pollInterval || setInterval(sampleDevices.bind(null, this), POLL_INTERVAL_MS);
              }.bind(this),
            );
            this._eventEmitter.on(
              'removeListener',
          ...
          function hasChangeListeners(mediaDevices) {
            return (
              ['devicechange', 'deviceinfochange'].reduce(function (count, event) {
            ...
            return (this._playPromise = Promise.all(
              this._sinkIds.map(function createAudioElement(sinkId) {
                ...
                return new Promise(function (resolve) {
                  ...
                  return (self._isSinkSupported ? audioElement.setSinkId(sinkId) : Promise.resolve()).then(
                    function setSinkIdSuccess() {
        ...
        function (require, module, exports) {
          ...
          const StatsMonitor = (function (_super) {
            ...
            function StatsMonitor(options) {
              ...
              _this._thresholds = { ...DEFAULT_THRESHOLDS, ...options.thresholds };
            ...
            StatsMonitor.prototype._createSample = function (stats, previousSample) {
              ...
              const currentPacketsLostFraction =
                currentInboundPackets > 0 ? (currentPacketsLost / currentInboundPackets) * 100 : 0;
              const totalInboundPackets = stats.packetsReceived + stats.packetsLost;
              const totalPacketsLostFraction =
                totalInboundPackets > 0 ? (stats.packetsLost / totalInboundPackets) * 100 : 100;
        ...
        function (require, module, exports) {
          ...
          const WSTransport = (function (_super) {
            ...
            function WSTransport(uris, options) {
              ...
              _this._onSocketClose = function (event) {
                ...
                if (event.code === 1006 || event.code === 1015) {
                  ...
                  const wasConnected =
                    _this.state === WSTransportState.Open || _this._previousState === WSTransportState.Open;
            ...
            WSTransport.prototype.open = function () {
              ...
              if (
                this._socket &&
                (this._socket.readyState === WebSocket.CONNECTING || this._socket.readyState === WebSocket.OPEN)
              ) {
        ...
        function (require, module, exports) {
          ...
          const AudioPlayer = (function (_EventTarget_1$defaul) {
            ...
            function AudioPlayer(audioContext) {
              const srcOrOptions = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
              let options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
              _classCallCheck(this, AudioPlayer);
              const _this = _possibleConstructorReturn(
                this,
                (AudioPlayer.__proto__ || Object.getPrototypeOf(AudioPlayer)).call(this),
              );
              ...
              },
              {
                ...
                set: function set(shouldLoop) {
                  if (!shouldLoop && this.loop && !this.paused) {
                    const _pauseAfterPlaythrough = function _pauseAfterPlaythrough() {
      ...
      51: [
        function (require, module, exports) {
          ...
          function failCheck(ExceptionConstructor, callee, messageFormat, formatArgs) {
            ...
            const message = util.format.apply(this, [messageFormat].concat(formatArgs));
          ...
          module.exports.checkIsDefAndNotNull = function (value, message) {
            ...
            failArgumentCheck(
              arguments.callee,
              message || `Expected value to be defined and not null but got "${typeOf(value)}".`,
              Array.prototype.slice.call(arguments, 2),
            );
          };
      ...
      57: [
        function (require, module, exports) {
          ...
          SDPUtils.writeCryptoKeyParams = function (keyParams) {
            return `${keyParams.keyMethod}:${keyParams.keySalt}${keyParams.lifeTime ? `|${keyParams.lifeTime}` : ''}${
