  ...
  try {
    ...
    if (event.hasOwnProperty('name') && event.name != undefined)
    {
      ...
      const parameters = {
        ...
        'APPLICATION_FILENAME_PATTERN_APPOINTMENT': await retrieveParameter(context, 'APPLICATION_FILENAME_PATTERN_APPOINTMENT'),
        ...
        'AWS_LAMBDA_SEND_REMINDERS': await retrieveParameter(context, 'AWS_LAMBDA_SEND_REMINDERS'),
